 ...
 * @param {r, g, b}
 */
ws281x.setPixelColor = function (position, {r, g, b, w}) {
    verifyInitialization();
    // console.log('color', rgb2Int(w, r, g, b))
    _pixelData[position] = rgb2Int(w, r, g, b);
};
...
function rgb2Int(w, r, g, b) {
    const cleanw = w.toString(16) === '0' ? '00' : w.toString(16)
    const cleanr = r.toString(16) === '0' ? '00' : r.toString(16)
    const cleang = g.toString(16) === '0' ? '00' : g.toString(16)
    const cleanb = b.toString(16) === '0' ? '00' : b.toString(16)
    return `0x${cleanw}${cleanr}${cleang}${cleanb}`
}
